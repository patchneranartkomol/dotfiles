...
" auto install vimplug if not present
...
au BufRead *.ts set makeprg=jslint\ %
autocmd filetype javascript set sw=2 ts=2 expandtab
autocmd filetype typescript set sw=2 ts=2 expandtab
autocmd filetype javascriptreact set sw=2 ts=2 expandtab
